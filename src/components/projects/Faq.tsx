...
/**
 * Faq - sparse-divider accordion.
 *
 * Section 8 of 9. Taste-skill audit:
 *   - One border-bottom between rows (not top AND bottom) per
 *     Section 9.F rule.
 *   - FAQ gets the only two eyebrows allowed on the page
 *     (FAQ + CTA band, 1-per-3 cap).
 *   - Detail uses the native <details>/<summary> for a11y, no
 *     bespoke disclosure JS.
 */
  ...
  return (
    ...
    >
      <div className="container-page">
        <p className="chrome-pill mb-3 inline-flex">Questions</p>
