      ...
      <div className="container-page grid grid-cols-1 md:grid-cols-12 gap-8 items-end">
        <div className="md:col-span-9">
          ...
          <h1 className="text-[clamp(3rem,10vw,8rem)] tracking-[-0.03em] leading-[0.9]">
            Nothing here.{" "}
            <em className="text-ink not-italic font-medium">Yet.</em>
          </h1>
        ...
        <div className="md:col-span-3 md:text-right">
          ...
          <p className="font-mono text-[10px] uppercase tracking-[0.22em] text-ink mt-1">
            Mail us
          </p>
          <a
            href="mailto:studio@etihadinteriors.com"
            className="block text-sm mt-2 hover:text-ink"
          >
